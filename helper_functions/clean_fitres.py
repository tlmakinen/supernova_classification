...
def makeMLDataframes(smearname):
    ...
    # selected SNe
    data_sel = pd.read_csv('/mnt/c/Users/lucas/Datasets/bahamas/data_snana/{}/FITOPT001.FITRES'.format(smearname), sep='\s+', skiprows=12)
    # bulk SNe
    data_all = pd.read_csv('/mnt/c/Users/lucas/Datasets/bahamas/data_snana/{}/SIMGEN.DAT'.format(smearname), sep='\s+', skiprows=9) # bulk simulated SNe
